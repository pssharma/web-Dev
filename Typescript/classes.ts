...
class Male extends Person {
  ...
  name = "PS"; //will overwrite name property in person class
...
class OnlyOne {
  ...
  private constructor(public name: string) { } //the constructor is private too so that it cant be instatianted. So we only have one instance of the class
  //hence the name singleton
   static getInstance() {   ///since this is singleton the method has to be static in order to access it. Because we can access it without instantiation
    if (OnlyOne.instance) {
